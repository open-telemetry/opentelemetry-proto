...
- logs: `SEVERITY_NUMBER_UNSPECIFIED` can be used as as the `severity_number` field is optional. [#736](https://github.com/open-telemetry/opentelemetry-proto/pull/736)
